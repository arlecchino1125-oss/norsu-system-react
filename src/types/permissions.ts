...
export const PERMISSION_DESCRIPTIONS: Record<PermissionType, Record<string, string>> = {
    table: {
        ...
        needs_assessment_forms: 'Needs assessment form definitions.',
        ...
        needs_assessment_submissions: 'Needs assessment submission records.',
        needs_assessment_answers: 'Needs assessment per-question response records.',
