                                ...
                                <Card key={form.id} className="hover:shadow-md transition-shadow duration-200">
                                    <CardContent>
                                        ...
                                        <div className="flex gap-3">
                                            <Button variant="primary" size="md" className="flex-1" onClick={() => handleEdit(form)}>Edit Form</Button>
                                            <Button variant="secondary" size="md" onClick={() => handlePreview(form)} title="Preview"><CheckCircle size={16} /></Button>
                                            {canArchiveRecords && (
                                                <Button variant="danger" size="md" onClick={() => setDeleteConfirm(form)} title="Deactivate Form"><Trash2 size={16} /></Button>
                                            )}
                                        </div>
                                    </CardContent>
                                </Card>
                        ...
                        <div className="fixed inset-0 bg-transparent flex items-center justify-center z-50 p-4">
                            <Card className="shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
                                <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                                    ...
                                    <Button variant="ghost" size="sm" onClick={() => setShowEditor(false)}><XCircle size={20} /></Button>
                                </div>
                                        ...
                                        {editingQuestions.map((q, idx) => {
                                            ...
                                            return (
                                                <div key={idx} className="flex gap-2 items-center">
                                                    ...
                                                    {canRemoveQuestion && (
                                                        <Button variant="danger" size="sm" className="border-l-0 rounded-l-none rounded-r-lg" onClick={() => removeQuestion(idx)}><Trash2 size={14} /></Button>
                                                    )}
                                                </div>
                                            );
                                        })}
                                ...
                                <div className="p-4 border-t bg-gray-50 flex justify-end gap-3">
                                    ...
                                    <Button variant="primary" onClick={handleSaveForm}>Save Changes</Button>
                                </div>
                            </Card>
                        </div>
                    )}
                        ...
                        <div className="fixed inset-0 bg-transparent flex items-center justify-center z-50 p-4">
                            <Card className="shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
                                <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                                    ...
                                    <Button variant="ghost" size="sm" onClick={() => setShowPreview(false)}><XCircle size={20} /></Button>
                                </div>
                    ...
                    {deleteConfirm && canArchiveRecords && (
                        <div className="fixed inset-0 bg-transparent flex items-center justify-center z-50 p-4">
                            <Card className="shadow-2xl w-full max-w-md p-6">
                                ...
                                <div className="flex gap-3">
                                    <Button variant="secondary" className="flex-1" onClick={() => setDeleteConfirm(null)} disabled={isDeleting}>Cancel</Button>
                                    <Button variant="danger" className="flex-1" onClick={handleDeleteForm} isLoading={isDeleting} leftIcon={<Trash2 size={14} />}>
                                        Deactivate Form
                                    </Button>
                                </div>
                            </Card>
                        ...
                        <div className="fixed inset-0 bg-transparent flex items-center justify-center z-50 p-4">
                            <Card className="shadow-2xl w-full max-w-3xl overflow-hidden">
                                <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
                                    ...
                                    <Button variant="ghost" size="sm" onClick={() => setShowInactiveModal(false)}><XCircle size={20} /></Button>
                                </div>
