...
// Re-use the same exportToExcel utility already defined in CareStaffNatPage
...
export function renderCareStaffModals(p: any) {
    ...
    return (
        <>
            ...
            <Modal
                open={showApplicationModal && !!selectedApp}
            ...
            <Modal
                ...
                footer={
                    <>
                        ...
                        <button type="submit" form="schedule-session-form" className="flex-1 py-2 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700">Confirm Schedule</button>
                    </>
                }
            >
                <form id="schedule-session-form" onSubmit={handleScheduleSubmit} className="space-y-4">
            ...
            <Modal
                ...
                title="Complete Counseling Session"
                size="md"
                footer={
                    <>
                        ...
                        <button type="submit" form="complete-session-form" className="flex-1 py-3 bg-green-600 text-white rounded-xl font-bold hover:bg-green-700">Complete Session</button>
                    </>
                }
            >
                <form id="complete-session-form" onSubmit={handleCompleteSession} className="space-y-4">
                    <div>
            ...
            <Modal
                ...
                subtitle="View and edit full student details"
                size="lg"
                footer={
                    <>
                        ...
                        <button type="submit" form="edit-student-form" className="px-6 py-2.5 bg-blue-600 text-white rounded-xl font-bold shadow-lg shadow-blue-200 hover:bg-blue-700 hover:scale-[1.02] transition-all">Save Changes</button>
                    </>
                }
            >
