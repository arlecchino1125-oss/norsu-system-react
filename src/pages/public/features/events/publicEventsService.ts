...
// Supabase session, so student_id + email travel with each write and the
// function resolves the real student row server-side.
...
export const verifyPublicStudent = async (studentId: string, email: string): Promise<PublicStudent> => {
...
export const getPublicEventStatus = async (studentId: string, email: string): Promise<PublicEventStatus[]> => {
...
export const publicTimeIn = async (eventId: number, studentId: string, email: string) => {
...
export const publicTimeOut = async (eventId: number, studentId: string, email: string) => {
...
export const publicEvaluate = async (
    eventId: number,
    studentId: string,
    email: string,
    formId: number,
...
export const publicRateEvent = async (
    eventId: number,
    studentId: string,
    email: string,
    scores: number[],
