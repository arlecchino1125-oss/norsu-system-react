                ...
                <div className="flex-1 overflow-y-auto bg-slate-50 p-3.5 sm:p-5 space-y-3.5">
                    ...
                    {form?.description && (
                        <div className="rounded-2xl border border-blue-100 bg-blue-50/60 p-3.5 sm:p-4 text-slate-700 shadow-sm">
                            <p className="text-[10px] font-black uppercase tracking-[0.12em] text-blue-700 mb-1">
                                Instructions
                            </p>
                                ...
                                return (
                                    <article
                                        ...
                                        className={`rounded-2xl border bg-white p-3.5 sm:p-4 shadow-sm transition-all ${
                                            isAnswered
                                                ? 'border-blue-200 ring-1 ring-blue-100/70'
                                                : 'border-slate-200'
                                        }`}
                                    >
                                        ...
                                        {question.question_type === 'text' && (
                                            <textarea
                                                className="mt-3 min-h-[88px] w-full resize-none rounded-xl border border-slate-200 bg-slate-50/50 px-3 py-2.5 text-sm text-slate-800 outline-none transition focus:border-blue-400 focus:bg-white focus:ring-2 focus:ring-blue-100"
                                                value={String(answer ?? '')}
