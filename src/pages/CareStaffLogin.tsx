                            ...
                            <div className="relative overflow-hidden rounded-[2rem] border border-white/80 bg-white/90 p-7 shadow-[0_34px_90px_-35px_rgba(30,41,59,0.58)] backdrop-blur-3xl sm:p-9">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-5">
                                    <div className="space-y-2 text-left">
                                        ...
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                placeholder="CARE Staff ID or email"
                                                value={username}
                                    ...
                                    <div className="flex items-center justify-center gap-3 pt-1 text-sm font-extrabold text-slate-500">
                                        <a href="/" className="inline-flex items-center justify-center gap-2 rounded-full px-3 py-1.5 transition-colors hover:bg-violet-50 hover:text-violet-700 focus:outline-none focus:ring-4 focus:ring-violet-500/20">
                                            <ArrowLeft size={16} />
                                            Back to Main Portal
                                        </a>
                                        <span className="text-slate-300">•</span>
                                        <a href="/privacy-policy" className="inline-flex items-center justify-center gap-1.5 rounded-full px-3 py-1.5 transition-colors hover:bg-violet-50 hover:text-violet-700 focus:outline-none focus:ring-4 focus:ring-violet-500/20">
                                            Privacy Policy
                                        </a>
                                    </div>
                                </form>
