                            ...
                            <div className="relative bg-[#0d1527]/90 backdrop-blur-3xl border border-indigo-500/30 rounded-[2.5rem] shadow-2xl p-8 overflow-hidden">
                                ...
                                <form onSubmit={handleLogin} className="space-y-5">
                                    ...
                                    <div className="pt-2 flex flex-col gap-3.5">
                                        ...
                                        >
                                            <UserPlus size={16} /> Activate Account
                                        </motion.button>
                                    </div>
                                </form>
                            </div>
                ...
                {showActivateModal && (
                    ...
                    >
                        <motion.div
                            ...
                            animate={{ scale: 1, y: 0 }}
                            exit={{ scale: 0.95, y: 20, opacity: 0 }}
                            className="bg-white w-full max-w-3xl max-h-[90vh] rounded-[2.5rem] shadow-2xl shadow-indigo-900/50 flex flex-col overflow-hidden relative"
                        >
                            {/* Modal Header */}
                                ...
                                <div className="p-8 border-t border-slate-100 bg-slate-50 flex justify-between items-center rounded-b-[2.5rem]">
                                    ...
                                    {activationStep < TOTAL_STEPS ? (
                                        ...
                                        <button
                                            ...
                                            disabled={loading}
                                            className="px-10 py-3 bg-gradient-to-r from-indigo-600 to-sky-500 text-white rounded-2xl font-black text-sm shadow-xl shadow-indigo-500/30 hover:shadow-2xl disabled:opacity-50 flex items-center gap-2 hover:-translate-y-0.5 transition-all active:scale-95"
                                        >
