                    ...
                    <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto p-6">
                        ...
                        <div className="space-y-5">
                            ...
                            <div>
                                ...
                                <input required type="date" value={referCareForm.date_acted} onChange={e => setReferCareForm({ ...referCareForm, date_acted: e.target.value })} className="w-full px-4 py-2.5 border rounded-xl text-sm" />
                            </div>
