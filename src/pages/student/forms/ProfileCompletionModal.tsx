...
const MAX_PROFILE_DOCUMENT_BYTES = 1024 * 1024;
                                    ...
                                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                                        <div className="h-24 w-24 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                                            {profilePhotoPreviewUrl || formData.profilePictureUrl ? (
                                                <img src={profilePhotoPreviewUrl || formData.profilePictureUrl} alt="Profile portrait preview" className="h-full w-full object-cover" />
                                            ) : (
