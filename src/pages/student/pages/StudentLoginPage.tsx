...
const ActivationSuccessModal = ({ credentials, onLogin }: any) => (
    <m.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
            ...
            <div className="max-w-sm mx-auto bg-indigo-50/50 border border-indigo-100 rounded-2xl p-6 mb-6 shadow-inner w-full text-left">
                <div className="space-y-4">
                    <div className="bg-white p-4 rounded-xl border border-indigo-100 shadow-sm relative overflow-hidden">
                        ...
                        <p className="font-mono font-bold text-xl text-slate-800 tracking-wider">{credentials?.username}</p>
                    </div>
            ...
            <AnimatePresence>
                {showSuccessModal && (
                    <ActivationSuccessModal
                        ...
                        onLogin={() => { setShowSuccessModal(false); handleActivatedCredentialsLogin(); }}
                    />
                )}
            </AnimatePresence>
