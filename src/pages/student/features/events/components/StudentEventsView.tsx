...
const EventRatingModal = ({ ratingForm, setRatingForm, submitRating, isSubmittingEventRating, personalInfo, setShowRatingModal }: any) => (
            ...
            <div className="flex-1 overflow-y-auto bg-slate-50 p-4 student-mobile-modal-scroll-panel sm:p-5">
                <div className="space-y-3">
                    ...
                    <section className="rounded-xl border border-slate-200 bg-white p-3 shadow-sm sm:rounded-2xl sm:p-4">
                        <div className="space-y-3">
                            <div>
                                <label htmlFor="activity-feedback-best" className="mb-1.5 block text-[12px] font-black text-slate-700">What I like best about the activity:</label>
                                <textarea
                                    id="activity-feedback-best"
                            ...
                            <div>
                                <label htmlFor="activity-feedback-suggestions" className="mb-1.5 block text-[12px] font-black text-slate-700">My suggestions to further improve the activity:</label>
                                <textarea
                                    id="activity-feedback-suggestions"
                                    {...getTextInputLimitProps('notes')}
                                    rows={3}
                            ...
                            <div>
                                <label htmlFor="activity-feedback-comments" className="mb-1.5 block text-[12px] font-black text-slate-700">Other comments:</label>
                                <textarea
                                    id="activity-feedback-comments"
                                    {...getTextInputLimitProps('notes')}
                                    rows={3}
                                    ...
                                    <div className="space-y-2">
                                        {canUseTimeIn && selectedEvent.require_photo !== false && (
                                            <>
                                                ...
                                                <input
                                                    aria-label="Attendance proof photo"
                                                    type="file"
                                                    accept="image/*"
