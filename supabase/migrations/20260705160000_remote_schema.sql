...
ALTER TABLE "public"."counseling_requests"
    ADD CONSTRAINT "counseling_requests_referrer_signature_len" CHECK ((("referrer_signature" IS NULL) OR ("char_length"("referrer_signature") <= 2048))) NOT VALID;
...
ALTER TABLE "public"."support_requests"
    ADD CONSTRAINT "support_requests_dept_notes_len" CHECK ((("dept_notes" IS NULL) OR ("char_length"("dept_notes") <= 4000))) NOT VALID;
