-- =============================================================================
-- Migration: Fix public_event_time_in event_attendance columns
-- Description: Corrects event_attendance insert in public_event_time_in by
-- removing non-existent columns (course, year_level, status).
-- =============================================================================
