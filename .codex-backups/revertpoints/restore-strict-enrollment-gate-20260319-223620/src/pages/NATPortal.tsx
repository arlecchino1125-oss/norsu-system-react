...
const NATPortal = () => {
    ...
    const [enrollConfirm, setEnrollConfirm] = useState<{ visible: boolean; studentId: string; course: string }>({ visible: false, studentId: '', course: '' });
    ...
    const handleActivation = async (e: any) => {
        ...
        try {
            ...
            if (String(error?.message || '').includes('Student ID not found in the enrollment list.')) {
                setEnrollConfirm({ visible: true, studentId, course });
            } else {
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm max-h-[90vh] overflow-y-auto border border-white/20 relative">
                                ...
                                <div className="p-6 space-y-4">
                                    ...
                                    <p className="text-xs text-gray-500 leading-relaxed">
                                        Please wait until your enrollment key is added by the school before activating your student account.
                                    </p>
                                    <div className="pt-2">
                                        <button
                                            type="button"
                                            onClick={() => { setEnrollConfirm({ visible: false, studentId: '', course: '' }); }}
                                            className="w-full py-3 rounded-xl font-bold text-gray-600 hover:bg-gray-100 transition-colors border border-gray-200"
                                        >Okay</button>
                                    </div>
                                </div>
                            </div>
