...
export default function AdminDashboard() {
    ...
    const isProvisioningUnavailableError = (message: string, status?: number | null, errorName?: string | null) => {
    ...
    const handleCreate = async (e: any) => {
        ...
        try {
            ...
            if (!isProvisioningUnavailableError(error?.message || '', error?.status, error?.errorName)) {
