    ...
    const loginStaff = useCallback(async (username: any, password: any, requiredRole: any) => {
        ...
        try {
            ...
            if (!resolvedEmail) {
                ...
                return {
                    success: false,
                    error: 'This staff account has no migrated auth email yet. Run the auth migration from the admin portal first.'
                };
            }
    ...
    const loginStudent = useCallback(async (studentId: any, password: any) => {
        ...
        try {
            ...
            if (!resolvedEmail) {
                ...
                return {
                    success: false,
                    error: 'This student account has no migrated auth email yet. Ask an admin to sync linked student auth emails first.'
                };
            }
